<template>
    ...
    <section class="about-banner my-5">
      <div class="container-fluid gif-banner p-0">
        ...
        <img src="../assets/images/banner.png" class="h-100 w-100" loading="lazy" alt="Pricing Banner" />
            ...
            <div class="card pricing-card">
              ...
              <div class="card-body pricing-card-body">
                ...
                <ul class="list-unstyled card-body-content pt-4">
                  ...
                  <li :class="{ inactive_service: !value.directly_contact_flag }">✓ Direct contact with rental/landlord.</li>
                  <li :class="{ inactive_service: !value.process_application_flag }">✓ Lease match processes application.</li>
                  <li :class="{ inactive_service: !value.necessary_doc_flag }">✓ Informed of necessary documents for application.</li>
                </ul>
              </div>
              <div class="card-footer pricing-card-footer text-center" v-if="index ==0">
                <a href="http://lmb.gregorygadson.io/" class="btn btn-package theme_btn2">Get Started</a>
              </div>
