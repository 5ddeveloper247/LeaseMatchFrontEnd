        ...
        <div class="container">
            <div class="row">
                <div class="col footer-items">
                    ...
                    <p class="text-dark">
                        We might share your data in specific scenarios, like password resets and landlord matchmaking, to
                    ...
                    <p class="text-dark">
                        ...
                        procedures for submitting such requests (Send a detailed message through the Contact Us portal).
                    </p>
                    ...
                    <p class="text-dark">
                        Remember, we’re here to make your search for the perfect home in New York City as seamless and
                        efficient as possible. If you have any questions or need clarifications, don’t hesitate to reach
                        out to us. Welcome to your journey with LeaseMatch.NYC!
                    </p>
                </div>
            </div>
        </div>
...
h1, h2, h5, p {
    ...
    color: #333; /* Uniform color for text */
}
